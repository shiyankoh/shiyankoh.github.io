...
I'd taken up baking like everyone else during the COVID-19 pandemic, precipitated by a friend's kind gift of a 3 year old sourdough starter. My first attempt was pretty sad. It didn't rise, was weirdly dense without the holes you want inside, and the outside was pretty uneven. It's also the first skill I've taught myself this year since we've mostly been in survival mode between work, COVID and kids.
...
1. Start with a rough mental framework of how to make sourdough (key steps, drivers) from perusing a range of recipes.
2. Test initial framework - Bake!
3. Iterate by varying each variable systematically until satisfied with the result - Keep baking!
4. Prove you can replicate results consistently. Bake with drivers consistent throughout. Enjoy warm bread =).
5. Realize:
