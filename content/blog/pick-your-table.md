...
description: "The future is unevenly distributed — not across geographies, but across dinner tables. Urgency is a social phenomenon, and proximity compounds."
tags:
  - communities
  - startups
  - singapore
...
A group called ABC ([agenticbuilders.sg](https://agenticbuilders.sg)) is a good example — four enthusiasts sharing tips that turned into a WhatsApp group, then live events, then a real community. They didn't set out to build an institution. They just kept the door open.
